...
def createTree(dataSet, leafType=regLeaf, errType=regErr, ops=(1, 4)):
    ...
    return retTree
```
[完整代码地址](https://github.com/wangjianbing1998/ML-master/blob/master/src/py2.x/ml/9.RegTrees/regTrees.py): <https://github.com/wangjianbing1998/ML-master/blob/master/src/py2.x/ml/9.RegTrees/regTrees.py>
...
[完整代码地址](https://github.com/wangjianbing1998/ML-master/blob/master/src/py2.x/ml/9.RegTrees/treeExplore.py): <https://github.com/wangjianbing1998/ML-master/blob/master/src/py2.x/ml/9.RegTrees/treeExplore.py>
