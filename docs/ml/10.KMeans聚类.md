...
#### 测试函数
1. 测试一下以上的基础函数是否可以如预期运行, 请看: <https://github.com/wangjianbing1998/ML-master/blob/master/src/py2.x/ml/10.kmeans/kMeans.py>
2. 测试一下 kMeans 函数是否可以如预期运行, 请看: <https://github.com/wangjianbing1998/ML-master/blob/master/src/py2.x/ml/10.kmeans/kMeans.py> 
...
#### 测试二分 KMeans 聚类算法
* 测试一下二分 KMeans 聚类算法，请看: <https://github.com/wangjianbing1998/ML-master/blob/master/src/py2.x/ml/10.kmeans/kMeans.py>
