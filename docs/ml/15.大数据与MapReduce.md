...
[完整代码地址](https://github.com/wangjianbing1998/ML-master/blob/master/src/py2.x/ml/15.BigData_MapReduce/pegasos.py): <https://github.com/wangjianbing1998/ML-master/blob/master/src/py2.x/ml/15.BigData_MapReduce/pegasos.py>

运行方式: `python /opt/git/MachineLearning/src/python/15.BigData_MapReduce/mrSVM.py < data/15.BigData_MapReduce/inputFile.txt`
[MR版本的代码地址](https://github.com/wangjianbing1998/ML-master/blob/master/src/py2.x/ml/15.BigData_MapReduce/mrSVM.py): <https://github.com/wangjianbing1998/ML-master/blob/master/src/py2.x/ml/15.BigData_MapReduce/mrSVM.py>
